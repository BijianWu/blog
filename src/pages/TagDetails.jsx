    ...
    return <>
        ...
        <List sx={{ listStyleType: 'disc' }}>
            <ListItem sx={{ display: 'list-item' }} >
                <StyledTypography>good article 2</StyledTypography>............ Nov 21, 2022
                </ListItem>
            <ListItem sx={{ display: 'list-item' }}><StyledTypography>good article 1</StyledTypography> ............ Nov 20, 2022</ListItem>
        </List>
    </>
}